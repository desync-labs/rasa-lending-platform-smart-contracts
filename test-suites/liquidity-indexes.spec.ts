...
makeSuite('Pool: liquidity indexes misc tests', (testEnv: TestEnv) => {
  ...
  it('Validates that the flash loan fee properly takes into account both RSToken supply and accruedToTreasury', async () => {
    const {
      pool,
      helpersContract,
      weth,
     ...
     * 3. Validates that liquidity index took into account both RSToken supply and accruedToTreasury
     */
