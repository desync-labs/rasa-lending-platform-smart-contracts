 ...
 * @notice Main registry of PoolAddressesProvider of RASA markets.
 * @dev Used for indexing purposes of RASA protocol's markets. The id assigned to a PoolAddressesProvider refers to the
 * market it is connected with, for example with `1` for the RASA main market and `2` for the next created.
 */
