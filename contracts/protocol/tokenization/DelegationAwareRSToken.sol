...
import {RSToken} from './RSToken.sol';

/**
 * @title DelegationAwareRSToken
 * @notice RSToken enabled to delegate voting power of the underlying asset to a different address
 * @dev The underlying asset needs to be compatible with the COMP delegation interface
 */
contract DelegationAwareRSToken is RSToken {
  /**
