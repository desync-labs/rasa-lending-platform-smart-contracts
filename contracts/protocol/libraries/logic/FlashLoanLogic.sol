...
library FlashLoanLogic {
  ...
  function executeFlashLoan(
    ...
    for (vars.i = 0; vars.i < params.assets.length; vars.i++) {
      ...
      vars.totalPremiums[vars.i] = DataTypes.InterestRateMode(params.interestRateModes[vars.i]) ==
        ...
        : 0;
      IRSToken(reservesData[params.assets[vars.i]].RSTokenAddress).transferUnderlyingTo(
  ...
  function executeFlashLoanSimple(
    ...
    IRSToken(reserve.RSTokenAddress).transferUnderlyingTo(params.receiverAddress, params.amount);
