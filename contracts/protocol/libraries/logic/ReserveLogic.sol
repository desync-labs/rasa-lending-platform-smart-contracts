...
library ReserveLogic {
   ...
   * @param reserve The reserve object
   * @param RSTokenAddress The address of the overlying RSToken contract
  ...
  function init(
    ...
    require(reserve.RSTokenAddress == address(0), Errors.RESERVE_ALREADY_INITIALIZED);

    reserve.liquidityIndex = uint128(WadRayMath.RAY);
    reserve.variableBorrowIndex = uint128(WadRayMath.RAY);
    reserve.RSTokenAddress = RSTokenAddress;
  ...
  function cache(
    ...
    reserveCache.RSTokenAddress = reserve.RSTokenAddress;
