...
/**
 * @title Pool contract
 * @notice Main point of interaction with an RASA protocol's market
 * - Users can:
 *   # Supply
 *   # Withdraw
 *   # Borrow
...
contract Pool is VersionedInitializable, PoolStorage, IPool {
  ...
  function finalizeTransfer(
    ...
    require(msg.sender == _reserves[asset].RSTokenAddress, Errors.CALLER_NOT_RSTOKEN);
