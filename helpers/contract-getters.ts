...
import { StakedTokenTransferStrategy } from '../types';
import { PullRewardsTransferStrategy } from '../types';
import {
  RASAOracle,
  ACLManager,
  RSToken,
...
export const getRSToken = async (address: tEthereumAddress): Promise<RSToken> =>
  getContract('RSToken', address);
...
export const getPriceOracle = async (address?: tEthereumAddress): Promise<RASAOracle> =>
...
export const getProtocolDataProvider = async (
  address?: tEthereumAddress
...
export const getRASAOracle = async (address?: tEthereumAddress): Promise<RASAOracle> =>
  getContract('RASAOracle', address || (await hre.deployments.get(ORACLE_ID)).address);
...
export const getFaucet = async (address?: string): Promise<Faucet> =>
  getContract('Faucet', address || (await hre.deployments.get(FAUCET_OWNABLE_ID)).address);

export const getWrappedTokenGateway = async (address?: string): Promise<WrappedTokenGatewayV3> => {
  return getContract('WrappedTokenGatewayV3', address);
};

export const getUiPoolDataProvider = async (address?: string): Promise<UiPoolDataProviderV3> =>
  getContract('UiPoolDataProviderV3', address);

export const getUiIncentiveDataProvider = async (
  address?: string
): Promise<UiIncentiveDataProviderV3> => getContract('UiIncentiveDataProviderV3', address);
...
export const getIncentivesV2 = async (address?: string): Promise<RewardsController> => {
...
export const getPullRewardsStrategy = async (
  ...
  getContract(
    ...
    address || (await hre.deployments.get(INCENTIVES_PULL_REWARDS_STRATEGY_ID)).address
  );
...
export const getStakedRewardsStrategy = async (
  ...
  getContract(
    ...
    address || (await hre.deployments.get(INCENTIVES_STAKED_TOKEN_STRATEGY_ID)).address
  );
