...
export const RSTOKEN_IMPL_ID = `RSToken-${MARKET_NAME}`;
export const DELEGATION_AWARE_RSTOKEN_IMPL_ID = `DelegationAwareRSToken-${MARKET_NAME}`;
...
export const ORACLE_ID = `RASAOracle-${MARKET_NAME}`;
...
export const COLLECTOR_PROXY_ID = `Collector-${PROXY_ID}-${MARKET_NAME}`;
export const COLLECTOR_IMPL_ID = `Collector-${IMPL_ID}-${MARKET_NAME}`;
...
export const RSTOKEN_PREFIX = `-RSToken-${MARKET_NAME}`;
...
export const STAKE_RASA_PROXY = `StakeRASA-${PROXY_ID}`;
